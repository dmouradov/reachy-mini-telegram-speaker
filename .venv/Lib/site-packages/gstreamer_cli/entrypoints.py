...
def gst_device_monitor_1_0_exe():
    return __run('gst-device-monitor-1.0.exe')
def gst_discoverer_1_0_exe():
    return __run('gst-discoverer-1.0.exe')
def gst_inspect_1_0_exe():
    return __run('gst-inspect-1.0.exe')
def gst_launch_1_0_exe():
    return __run('gst-launch-1.0.exe')
def gst_play_1_0_exe():
    return __run('gst-play-1.0.exe')
def gst_typefind_1_0_exe():
    return __run('gst-typefind-1.0.exe')
def ges_launch_1_0_exe():
    return __run('ges-launch-1.0.exe')
def gst_dots_viewer_exe():
    return __run('gst-dots-viewer.exe')
def gst_validate_1_0_exe():
    return __run('gst-validate-1.0.exe')
def gst_validate_media_check_1_0_exe():
    return __run('gst-validate-media-check-1.0.exe')
def gst_validate_rtsp_server_1_0_exe():
    return __run('gst-validate-rtsp-server-1.0.exe')
def gst_validate_transcoding_1_0_exe():
    return __run('gst-validate-transcoding-1.0.exe')
